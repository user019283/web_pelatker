...
@section('title', 'Barista (Pengolahan Kopi)')
...
@section('content')
    <div class="container py-5">
        <div class="row">
            <div class="col-md-6">
                <!-- Gambar Utama -->
                <img id="mainImage" src="https://via.placeholder.com/500x400" alt="Barista Course Image" class="img-fluid mb-4 shadow-sm rounded">
            ...
            <div class="col-md-6">
                <h2 class="text-dark font-weight-bold" style="font-size: 36px;">Barista (Pengolahan Kopi)</h2>
                <p class="lead">Belajar teknik dasar pengolahan kopi, mulai dari menyeduh hingga pelayanan kepada pelanggan.</p>
                
                <h4 class="mt-4">Apa yang Akan Dipelajari</h4>
                <ul class="list-unstyled ml-3">
                    <li><i class="fas fa-check-circle text-success"></i> Teknik dasar menyeduh kopi</li>
                    <li><i class="fas fa-check-circle text-success"></i> Penggunaan mesin espresso</li>
                    <li><i class="fas fa-check-circle text-success"></i> Pelayanan dan presentasi kopi</li>
                    <li><i class="fas fa-check-circle text-success"></i> Mengenal berbagai jenis kopi dan asalnya</li>
                    <li><i class="fas fa-check-circle text-success"></i> Teknik latte art dasar</li>
                    <li><i class="fas fa-check-circle text-success"></i> Pengelolaan bisnis kedai kopi</li>
                </ul>
