...
@section('content')
    <div class="container py-5">
        <div class="row">
            <div class="col-md-6">
                <!-- Gambar Utama -->
                <img id="mainImage" src="https://via.placeholder.com/500x400" alt="Design Grafis Course Image" class="img-fluid mb-4 shadow-sm rounded">
            ...
            <div class="col-md-6">
                <h2 class="text-dark font-weight-bold" style="font-size: 36px;">Design Grafis</h2>
                <p class="lead">Belajar teknik desain grafis, mulai dari konsep dasar hingga penguasaan software desain modern.</p>
                
                <h4 class="mt-4">Apa yang Akan Dipelajari</h4>
                <ul class="list-unstyled ml-3">
                    <li><i class="fas fa-check-circle text-success"></i> Dasar-dasar desain grafis</li>
                    <li><i class="fas fa-check-circle text-success"></i> Penggunaan software desain seperti Adobe Photoshop dan Illustrator</li>
                    <li><i class="fas fa-check-circle text-success"></i> Tipografi, warna, dan layout</li>
                    <li><i class="fas fa-check-circle text-success"></i> Desain logo dan branding</li>
                    <li><i class="fas fa-check-circle text-success"></i> Pengolahan gambar digital</li>
                </ul>
                ...
                <ul class="list-unstyled ml-3">
                    ...
                    <li><i class="fas fa-pencil-ruler text-secondary"></i> Memiliki minat dalam bidang desain grafis</li>
                </ul>
