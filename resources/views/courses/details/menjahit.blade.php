...
@section('content')
    <div class="container py-5">
        <div class="row">
            <div class="col-md-6">
                <!-- Gambar Utama -->
                <img id="mainImage" src="https://via.placeholder.com/500x400" alt="Menjahit Course Image" class="img-fluid mb-4 shadow-sm rounded">
            ...
            <div class="col-md-6">
                <h2 class="text-dark font-weight-bold" style="font-size: 36px;">Menjahit</h2>
                <p class="lead">Belajar teknik dasar menjahit, mulai dari membuat pola, memotong kain, hingga proses menjahit dan finishing yang rapi.</p>
                
                <h4 class="mt-4">Apa yang Akan Dipelajari</h4>
                <ul class="list-unstyled ml-3">
                    <li><i class="fas fa-check-circle text-success"></i> Teknik dasar menjahit tangan dan mesin</li>
                    <li><i class="fas fa-check-circle text-success"></i> Membuat pola pakaian dasar</li>
                    <li><i class="fas fa-check-circle text-success"></i> Teknik memotong kain dengan presisi</li>
                    <li><i class="fas fa-check-circle text-success"></i> Menjahit berbagai jenis pakaian</li>
                    <li><i class="fas fa-check-circle text-success"></i> Finishing dan penyelesaian akhir</li>
                </ul>
                ...
                <ul class="list-unstyled ml-3">
                    ...
                    <li><i class="fas fa-scissors text-secondary"></i> Minat di bidang fashion dan pembuatan pakaian</li>
                </ul>
