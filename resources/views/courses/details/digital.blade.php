...
@section('content')
    <div class="container py-5">
        <div class="row">
            <div class="col-md-6">
                <!-- Gambar Utama -->
                <img id="mainImage" src="https://via.placeholder.com/500x400" alt="Digital Marketing Course Image" class="img-fluid mb-4 shadow-sm rounded">
            ...
            <div class="col-md-6">
                <h2 class="text-dark font-weight-bold" style="font-size: 36px;">Digital Marketing</h2>
                <p class="lead">Pelajari strategi pemasaran digital yang efektif dan aplikatif untuk mengembangkan bisnis online Anda.</p>
                
                <h4 class="mt-4">Apa yang Akan Dipelajari</h4>
                <ul class="list-unstyled ml-3">
                    <li><i class="fas fa-check-circle text-success"></i> Pengantar Digital Marketing dan Tren Terbaru</li>
                    <li><i class="fas fa-check-circle text-success"></i> Strategi SEO dan SEM untuk Meningkatkan Trafik Website</li>
                    <li><i class="fas fa-check-circle text-success"></i> Pengelolaan Media Sosial untuk Bisnis</li>
                    <li><i class="fas fa-check-circle text-success"></i> Pemasaran Konten (Content Marketing)</li>
                    <li><i class="fas fa-check-circle text-success"></i> Email Marketing dan Otomatisasi</li>
                    <li><i class="fas fa-check-circle text-success"></i> Analisis dan Pelaporan Kinerja Kampanye Digital</li>
                </ul>
                ...
                <ul class="list-unstyled ml-3">
                    ...
                    <li><i class="fas fa-camera text-secondary"></i> Untuk Digital Marketing Harus Memiliki Pengetahuan Dasar Tentang Penggunaan Internet dan Media Sosial</li>
                </ul>
