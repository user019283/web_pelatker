...
@section('content')
    <div class="container py-5">
        <div class="row">
            <div class="col-md-6">
                <!-- Gambar Utama -->
                <img id="mainImage" src="https://via.placeholder.com/500x400" alt="Membatik Course Image" class="img-fluid mb-4 shadow-sm rounded">
            ...
            <div class="col-md-6">
                <h2 class="text-dark font-weight-bold" style="font-size: 36px;">Membatik</h2>
                <p class="lead">Pelajari teknik dasar membatik tradisional dengan menggunakan lilin dan canting, serta teknik modern untuk menghasilkan karya batik berkualitas.</p>
                
                <h4 class="mt-4">Apa yang Akan Dipelajari</h4>
                <ul class="list-unstyled ml-3">
                    <li><i class="fas fa-check-circle text-success"></i> Sejarah dan filosofi batik</li>
                    <li><i class="fas fa-check-circle text-success"></i> Teknik membatik menggunakan canting dan lilin</li>
                    <li><i class="fas fa-check-circle text-success"></i> Pemilihan warna dan motif tradisional dan modern</li>
                    <li><i class="fas fa-check-circle text-success"></i> Proses pewarnaan dan finishing kain batik</li>
                    <li><i class="fas fa-check-circle text-success"></i> Pembuatan desain motif batik</li>
                </ul>
                ...
                <ul class="list-unstyled ml-3">
                    ...
                    <li><i class="fas fa-paint-brush text-secondary"></i> Minat di bidang seni dan kerajinan tangan, khususnya batik</li>
                </ul>
