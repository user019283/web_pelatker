...
@section('title', 'Service Sepeda Motor Injeksi')
...
@section('content')
    <div class="container py-5">
        <div class="row">
            <div class="col-md-6">
                <!-- Gambar Utama -->
                <img id="mainImage" src="https://via.placeholder.com/500x400" alt="Service Sepeda Motor Injeksi Course Image" class="img-fluid mb-4 shadow-sm rounded">
            ...
            <div class="col-md-6">
                <h2 class="text-dark font-weight-bold" style="font-size: 36px;">Service Sepeda Motor Injeksi</h2>
                <p class="lead">Belajar perawatan dan perbaikan sepeda motor injeksi secara profesional dengan teknik modern.</p>
                
                <h4 class="mt-4">Apa yang Akan Dipelajari</h4>
                <ul class="list-unstyled ml-3">
                    <li><i class="fas fa-check-circle text-success"></i> Dasar-dasar sistem injeksi bahan bakar</li>
                    <li><i class="fas fa-check-circle text-success"></i> Cara kerja sensor dan aktuator sepeda motor injeksi</li>
                    <li><i class="fas fa-check-circle text-success"></i> Pemrograman ECU (Electronic Control Unit)</li>
                    <li><i class="fas fa-check-circle text-success"></i> Teknik diagnosa dan perbaikan kerusakan</li>
                    <li><i class="fas fa-check-circle text-success"></i> Penggunaan alat scan injeksi motor</li>
                </ul>
                ...
                <ul class="list-unstyled ml-3">
                    ...
                    <li><i class="fas fa-file-alt text-secondary"></i> Ijazah Terakhir (2 Lembar)</li>
