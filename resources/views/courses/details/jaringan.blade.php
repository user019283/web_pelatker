...
@section('content')
    <div class="container py-5">
        <div class="row">
            <div class="col-md-6">
                <!-- Gambar Utama -->
                <img id="mainImage" src="https://via.placeholder.com/500x400" alt="Teknik Komputer dan Jaringan Course Image" class="img-fluid mb-4 shadow-sm rounded">
            ...
            <div class="col-md-6">
                <h2 class="text-dark font-weight-bold" style="font-size: 36px;">Teknik Komputer dan Jaringan</h2>
                <p class="lead">Pelajari dasar-dasar komputer dan jaringan, mulai dari konfigurasi perangkat keras hingga pengelolaan jaringan komputer.</p>
                
                <h4 class="mt-4">Apa yang Akan Dipelajari</h4>
                <ul class="list-unstyled ml-3">
                    <li><i class="fas fa-check-circle text-success"></i> Dasar-dasar perangkat keras komputer</li>
                    <li><i class="fas fa-check-circle text-success"></i> Instalasi dan konfigurasi jaringan LAN dan WLAN</li>
                    <li><i class="fas fa-check-circle text-success"></i> Troubleshooting perangkat keras dan jaringan</li>
                    <li><i class="fas fa-check-circle text-success"></i> Keamanan jaringan komputer</li>
                    <li><i class="fas fa-check-circle text-success"></i> Pengelolaan server dan perangkat jaringan</li>
                </ul>
                ...
                <ul class="list-unstyled ml-3">
                    ...
                    <li><i class="fas fa-network-wired text-secondary"></i> Memiliki dasar-dasar dalam penggunaan komputer dan jaringan</li>
                </ul>
