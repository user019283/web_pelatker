...
@section('content')
    <div class="container py-5">
        <div class="row">
            <div class="col-md-6">
                <!-- Gambar Utama -->
                <img id="mainImage" src="https://via.placeholder.com/500x400" alt="Fotografi Course Image" class="img-fluid mb-4 shadow-sm rounded">
            ...
            <div class="col-md-6">
                <h2 class="text-dark font-weight-bold" style="font-size: 36px;">Fotografi</h2>
                <p class="lead">Pelajari dasar-dasar fotografi, mulai dari teknik pengambilan gambar hingga pengolahan foto digital.</p>
                
                <h4 class="mt-4">Apa yang Akan Dipelajari</h4>
                <ul class="list-unstyled ml-3">
                    <li><i class="fas fa-check-circle text-success"></i> Teknik dasar pengambilan gambar</li>
                    <li><i class="fas fa-check-circle text-success"></i> Komposisi dan pencahayaan dalam fotografi</li>
                    <li><i class="fas fa-check-circle text-success"></i> Penggunaan kamera DSLR dan mirrorless</li>
                    <li><i class="fas fa-check-circle text-success"></i> Pengolahan foto digital menggunakan software editing</li>
                    <li><i class="fas fa-check-circle text-success"></i> Teknik fotografi potret dan lanskap</li>
                </ul>
                ...
                <ul class="list-unstyled ml-3">
                    ...
                    <li><i class="fas fa-camera text-secondary"></i> Memiliki dasar-dasar penggunaan kamera dan software editing</li>
                </ul>
